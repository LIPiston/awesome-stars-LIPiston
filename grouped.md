...
- [`cfour-hi/gitstars`](https://github.com/cfour-hi/gitstars) ★1726 — *Vue* — _cfour-hi_
  
  > Github Starred Repositories Manager
- [`Heavrnl/nexus-terminal`](https://github.com/Heavrnl/nexus-terminal) ★1339 — *TypeScript* — _Heavrnl_
  
  > 一款现代化的 Web SSH / RDP / VNC 客户端，提供独立桌面端，支持人机验证、2FA、界面定制、操作审计等强大功能。
- [`LibreSpark/LibreTV`](https://github.com/LibreSpark/LibreTV) ★11054 — *JavaScript* — _LibreSpark_
...
- [`1234567Yang/cf-proxy-ex`](https://github.com/1234567Yang/cf-proxy-ex) ★1547 — *JavaScript* — _1234567Yang_
...
- [`zed-industries/zed`](https://github.com/zed-industries/zed) ★64109 — *Rust* — _zed-industries_
...
- [`ccbikai/Sink`](https://github.com/ccbikai/Sink) ★5117 — *Vue* — _ccbikai_
...
- [`wekan/wekan`](https://github.com/wekan/wekan) ★20522 — *JavaScript* — _wekan_
...
- [`ruffle-rs/ruffle`](https://github.com/ruffle-rs/ruffle) ★17092 — *Rust* — _ruffle-rs_
  
  > A Flash Player emulator written in Rust
- [`moeyy01/gh-proxy-go`](https://github.com/moeyy01/gh-proxy-go) ★145 — *Go* — _moeyy01_
- [`yonggekkk/warp-yg`](https://github.com/yonggekkk/warp-yg) ★4057 — *Shell* — _yonggekkk_
...
- [`MarSeventh/CloudFlare-ImgBed`](https://github.com/MarSeventh/CloudFlare-ImgBed) ★2844 — *JavaScript* — _MarSeventh_
...
- [`scriptscat/scriptcat`](https://github.com/scriptscat/scriptcat) ★3294 — *TypeScript* — _scriptscat_
  
  > ScriptCat, a browser extension that can execute userscript; 脚本猫，一个可以执行用户脚本的浏览器扩展

## 📂 Windows工具 (22 Repos)

- [`ShadowWhisperer/Remove-MS-Edge`](https://github.com/ShadowWhisperer/Remove-MS-Edge) ★4073 — *Python* — _ShadowWhisperer_
  
  > Uninstall Microsoft Edge with an executable or batch script.
- [`jark006/jarkViewer`](https://github.com/jark006/jarkViewer) ★491 — *C++* — _jark006_
  
  > A simple image viewer   一款简单的看图软件
- [`liriliri/aya`](https://github.com/liriliri/aya) ★3538 — *TypeScript* — _liriliri_
  
  > Android ADB desktop app
- [`maotoumao/MusicFree`](https://github.com/maotoumao/MusicFree) ★19780 — *TypeScript* — _maotoumao_
  
  > 插件化、定制化、无广告的免费音乐播放器
- [`microsoft/WSL`](https://github.com/microsoft/WSL) ★29613 — *C++* — _microsoft_
  
  > Windows Subsystem for Linux
- [`LGUG2Z/komorebi`](https://github.com/LGUG2Z/komorebi) ★12395 — *Rust* — _LGUG2Z_
  
  > A tiling window manager for Windows 🍉
- [`saber-notes/saber`](https://github.com/saber-notes/saber) ★3504 — *Dart* — _saber-notes_
  
  > The cross-platform open-source app built for handwriting
- [`rcmaehl/MSEdgeRedirect`](https://github.com/rcmaehl/MSEdgeRedirect) ★5168 — *AutoIt* — _rcmaehl_
  
  > A Tool to Redirect News, Search, Widgets, Weather and More to Your Default Browser
- [`MustardChef/WSABuilds`](https://github.com/MustardChef/WSABuilds) ★11173 — *Python* — _MustardChef_
  
  > Run Windows Subsystem For Android on your Windows 10 and Windows 11 PC using prebuilt binaries with Google Play Store (MindTheGapps) and/or Magisk or KernelSU (root solutions) built in.
- [`HuLaSpark/HuLa`](https://github.com/HuLaSpark/HuLa) ★3580 — *Vue* — _HuLaSpark_
...
- [`ayangweb/BongoCat`](https://github.com/ayangweb/BongoCat) ★9551 — *TypeScript* — _ayangweb_
...
- [`keleus/BewlyCat`](https://github.com/keleus/BewlyCat) ★660 — *Vue* — _keleus_
...
- [`mulaRahul/keyviz`](https://github.com/mulaRahul/keyviz) ★8004 — *Dart* — _mulaRahul_
  
  > Keyviz is a free and open-source tool to visualize your keystrokes ⌨️ and 🖱️ mouse actions in real-time.
- [`yoopta-editor/Yoopta-Editor`](https://github.com/yoopta-editor/Yoopta-Editor) ★2413 — *TypeScript* — _yoopta-editor_
  
  > Build Notion-like, Craft-like, Coda-like, Medium-like editors with Yoopta

## 📂 安卓app (17 Repos)

- [`AChep/keyguard-app`](https://github.com/AChep/keyguard-app) ★1956 — *Kotlin* — _AChep_
...
- [`saber-notes/saber`](https://github.com/saber-notes/saber) ★3504 — *Dart* — _saber-notes_
  ...
  > The cross-platform open-source app built for handwriting
- [`lz233/Tarnhelm`](https://github.com/lz233/Tarnhelm) ★630 — *Kotlin* — _lz233_
  
  > The magic to clean sharing links up.
- [`algerkong/AlgerMusicPlayer`](https://github.com/algerkong/AlgerMusicPlayer) ★10550 — *Vue* — _algerkong_
  
  > 一个第三方音乐播放器、本地服务、桌面歌词、音乐下载、远程控制
- [`WuDi-ZhanShen/ShizukuRunner`](https://github.com/WuDi-ZhanShen/ShizukuRunner) ★237 — *Java* — _WuDi-ZhanShen_
  
  > 以shizuku身份执行命令的安卓小工具。A 50KB android app to run any commands via Shizuku.
- [`JunkFood02/Seal`](https://github.com/JunkFood02/Seal) ★21270 — *Kotlin* — _JunkFood02_
  
  > 🦭 Video/Audio Downloader for Android, based on yt-dlp, designed with Material You
- [`guozhigq/pilipala`](https://github.com/guozhigq/pilipala) ★12286 — *Dart* — _guozhigq_
  
  > PiliPala 是使用Flutter开发的BiliBili第三方客户端，感谢使用。
- [`daybreak1929/ViaBrowserCollection`](https://github.com/daybreak1929/ViaBrowserCollection) ★126 — *None* — _daybreak1929_
...
- [`pzcn/Perfect-Icons-Completion-Project`](https://github.com/pzcn/Perfect-Icons-Completion-Project) ★438 — *Shell* — _pzcn_
  ...
  > MIUI 完美图标补全计划
- [`hongchacha/cartoon`](https://github.com/hongchacha/cartoon) ★2433 — *None* — _hongchacha_
  
  > 全是漫画，免费漫画app
- [`youniaogu/MangaReader`](https://github.com/youniaogu/MangaReader) ★2380 — *TypeScript* — _youniaogu_
  
  > 一个漫画 APP📱，基于 react-native 构建，兼容 Android、Ios 平台
- [`wxxsfxyzm/InstallerX-Revived`](https://github.com/wxxsfxyzm/InstallerX-Revived) ★758 — *Kotlin* — _wxxsfxyzm_
  
  > More Expressive InstallerX !
- [`vvb2060/PackageInstaller`](https://github.com/vvb2060/PackageInstaller) ★328 — *Kotlin* — _vvb2060_
...
- [`Textualize/textual`](https://github.com/Textualize/textual) ★30585 — *Python* — _Textualize_
...
- [`juliangarnier/anime`](https://github.com/juliangarnier/anime) ★63298 — *JavaScript* — _juliangarnier_
...
- [`alovajs/alova`](https://github.com/alovajs/alova) ★3765 — *TypeScript* — _alovajs_
  
  > The Request Toolkit For Ultimate Efficiency
- [`NervJS/taro`](https://github.com/NervJS/taro) ★36829 — *TypeScript* — _NervJS_
  
  > 开放式跨端跨框架解决方案，支持使用 React/Vue 等框架来开发微信/京东/百度/支付宝/字节跳动/ QQ 小程序/H5/React Native 等应用。  https://taro.zone/
- [`tauri-apps/tauri`](https://github.com/tauri-apps/tauri) ★95754 — *Rust* — _tauri-apps_
  
  > Build smaller, faster, and more secure desktop and mobile applications with a web frontend.
- [`mitesh77/Best-Flutter-UI-Templates`](https://github.com/mitesh77/Best-Flutter-UI-Templates) ★21939 — *Dart* — _mitesh77_
  
  > completely free for everyone. Its build-in Flutter Dart.
- [`fail2ban/fail2ban`](https://github.com/fail2ban/fail2ban) ★15227 — *Python* — _fail2ban_
  
  > Daemon to ban hosts that cause multiple authentication errors
- [`fuma-nama/fumadocs`](https://github.com/fuma-nama/fumadocs) ★7717 — *TypeScript* — _fuma-nama_
  
  > The beautiful docs framework with Next.js and any React.js framework.
- [`vuetifyjs/vuetify`](https://github.com/vuetifyjs/vuetify) ★40681 — *TypeScript* — _vuetifyjs_
  
  > 🐉 Vue Component Framework
- [`tusen-ai/naive-ui`](https://github.com/tusen-ai/naive-ui) ★17568 — *TypeScript* — _tusen-ai_
  
  > A Vue 3 Component Library. Fairly Complete. Theme Customizable. Uses TypeScript. Fast.
- [`Nuitka/Nuitka`](https://github.com/Nuitka/Nuitka) ★13662 — *Python* — _Nuitka_
  
  > Nuitka is a Python compiler written in Python.  It's fully compatible with Python 2.6, 2.7, 3.4-3.13. You feed it your Python app, it does a lot of clever things, and spits out an executable or extension module.
- [`zhiyiYo/PyQt-Fluent-Widgets`](https://github.com/zhiyiYo/PyQt-Fluent-Widgets) ★7025 — *Python* — _zhiyiYo_
  
  > A fluent design widgets library based on C++ Qt/PyQt/PySide. Make Qt Great Again.
- [`duckdb/duckdb`](https://github.com/duckdb/duckdb) ★32147 — *C++* — _duckdb_
...
- [`bukson/steampy`](https://github.com/bukson/steampy) ★643 — *Python* — _bukson_
  ...
  > A Steam trading library for python 3
- [`skiptools/skip`](https://github.com/skiptools/skip) ★1938 — *Swift* — _skiptools_
  
  > Skip enables the creation of native SwiftUI apps for iOS and Android
- [`bezzad/Downloader`](https://github.com/bezzad/Downloader) ★1506 — *C#* — _bezzad_
...
- [`google-gemini/gemini-cli`](https://github.com/google-gemini/gemini-cli) ★70777 — *TypeScript* — _google-gemini_
  
  > An open-source AI agent that brings the power of Gemini directly into your terminal.
- [`qd-today/qd`](https://github.com/qd-today/qd) ★5081 — *Python* — _qd-today_
  
  > QD [v20240210] —— HTTP请求定时任务自动执行框架 base on HAR Editor and Tornado Server
- [`coracoo/awesome_docker_cn`](https://github.com/coracoo/awesome_docker_cn) ★2399 — *None* — _coracoo_
  
  > 上百款可docker部署的项目，包含项目地址、项目部署教程等。
- [`veggiemonk/awesome-docker`](https://github.com/veggiemonk/awesome-docker) ★33395 — *None* — _veggiemonk_
  
  > :whale: A curated list of Docker resources and projects
- [`jellyfin/jellyfin`](https://github.com/jellyfin/jellyfin) ★42797 — *C#* — _jellyfin_
  
  > The Free Software Media System - Server Backend & API
- [`halo-dev/halo`](https://github.com/halo-dev/halo) ★36603 — *Java* — _halo-dev_
  
  > 强大易用的开源建站工具。
- [`NginxProxyManager/nginx-proxy-manager`](https://github.com/NginxProxyManager/nginx-proxy-manager) ★28101 — *JavaScript* — _NginxProxyManager_
...
- [`Meloong-Git/PCL`](https://github.com/Meloong-Git/PCL) ★4543 — *Visual Basic .NET* — _Meloong-Git_
...
- [`Pumpkin-MC/Pumpkin`](https://github.com/Pumpkin-MC/Pumpkin) ★5405 — *Rust* — _Pumpkin-MC_
...
- [`TGwear/TGwear`](https://github.com/TGwear/TGwear) ★86 — *Java* — _TGwear_
  
  > ‎Telegram for Android watch & wearos
- [`groupultra/telegram-search`](https://github.com/groupultra/telegram-search) ★2776 — *TypeScript* — _groupultra_
...
- [`AstrBotDevs/AstrBot`](https://github.com/AstrBotDevs/AstrBot) ★11553 — *Python* — _AstrBotDevs_
  
  > ✨ 易上手的多平台 LLM 聊天机器人及开发框架 ✨ 支持 QQ、QQ频道、Telegram、企微、飞书、钉钉 | 知识库、MCP 服务器、OpenAI、DeepSeek、Gemini、硅基流动、月之暗面、Ollama、OneAPI、Dify
- [`koishijs/koishi`](https://github.com/koishijs/koishi) ★5164 — *TypeScript* — _koishijs_
...
- [`chenzyadb/CuprumTurbo-Scheduler`](https://github.com/chenzyadb/CuprumTurbo-Scheduler) ★397 — *Shell* — _chenzyadb_
...
- [`KernelSU-Next/KernelSU-Next`](https://github.com/KernelSU-Next/KernelSU-Next) ★2230 — *Kotlin* — _KernelSU-Next_
...
- [`voideditor/void`](https://github.com/voideditor/void) ★26680 — *TypeScript* — _voideditor_
- [`yeongpin/cursor-free-vip`](https://github.com/yeongpin/cursor-free-vip) ★34644 — *Python* — _yeongpin_
...
- [`zgsm-ai/costrict`](https://github.com/zgsm-ai/costrict) ★1583 — *TypeScript* — _zgsm-ai_
...
- [`dongyuwei/hallelujahIM`](https://github.com/dongyuwei/hallelujahIM) ★2398 — *Objective-C++* — _dongyuwei_
  
  > hallelujahIM(哈利路亚 英文输入法) is  an intelligent English input method with auto-suggestions and spell check features.
- [`goto456/stopwords`](https://github.com/goto456/stopwords) ★5260 — *None* — _goto456_
  
  > 中文常用停用词表（哈工大停用词表、百度停用词表等）
- [`brightmart/nlp_chinese_corpus`](https://github.com/brightmart/nlp_chinese_corpus) ★9769 — *None* — _brightmart_
...
- [`krillinai/KlicStudio`](https://github.com/krillinai/KlicStudio) ★8316 — *Go* — _krillinai_
...
- [`comfyanonymous/ComfyUI`](https://github.com/comfyanonymous/ComfyUI) ★86088 — *Python* — _comfyanonymous_
  
  > The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
- ⚠️ Repo ID `983303900` not found in data.json.
- [`browser-use/workflow-use`](https://github.com/browser-use/workflow-use) ★3656 — *TypeScript* — _browser-use_
  
  > ⚙️ Create and run workflows (RPA 2.0)
- [`punkpeye/awesome-mcp-servers`](https://github.com/punkpeye/awesome-mcp-servers) ★66738 — *None* — _punkpeye_
  
  > A collection of MCP servers.
- [`xming521/WeClone`](https://github.com/xming521/WeClone) ★15355 — *Python* — _xming521_
...
- [`simular-ai/Agent-S`](https://github.com/simular-ai/Agent-S) ★6154 — *Python* — _simular-ai_
  
  > Agent S: an open agentic framework that uses computers like a human
- [`x1xhlol/system-prompts-and-models-of-ai-tools`](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) ★77898 — *None* — _x1xhlol_
...
- [`hacksider/Deep-Live-Cam`](https://github.com/hacksider/Deep-Live-Cam) ★72614 — *Python* — _hacksider_
  
  > real time face swap and one-click video deepfake with only a single image
- [`yeongpin/cursor-free-vip`](https://github.com/yeongpin/cursor-free-vip) ★34644 — *Python* — _yeongpin_
  
  > [Support 0.49.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
- [`chatanywhere/GPT_API_free`](https://github.com/chatanywhere/GPT_API_free) ★31794 — *Python* — _chatanywhere_
...
- [`github/github-mcp-server`](https://github.com/github/github-mcp-server) ★21415 — *Go* — _github_
...
- [`pagefaultgames/pokerogue`](https://github.com/pagefaultgames/pokerogue) ★5306 — *TypeScript* — _pagefaultgames_
  
  > A browser based Pokémon fangame heavily inspired by the roguelite genre.
- [`libnoname/noname`](https://github.com/libnoname/noname) ★3750 — *JavaScript* — _libnoname_
- [`popcap-games/Plants-vs-Zombies-GOTY`](https://github.com/popcap-games/Plants-vs-Zombies-GOTY) ★22 — *None* — _popcap-games_
...
- [`zer0k-z/cs2-movement-issues`](https://github.com/zer0k-z/cs2-movement-issues) ★83 — *Python* — _zer0k-z_
...
- [`1995chen/dnf`](https://github.com/1995chen/dnf) ★1506 — *Shell* — _1995chen_

## 📂 proxy (5 Repos)

- [`fscarmen/ArgoX`](https://github.com/fscarmen/ArgoX) ★1494 — *Shell* — _fscarmen_
...
- [`yonggekkk/sing-box-yg`](https://github.com/yonggekkk/sing-box-yg) ★5134 — *Shell* — _yonggekkk_
  
  > Sing-box精装桶四合一协议VPS专用脚本：三大独家功能！自签/acme双证书切换、Argo固定临时双隧道（可共存）、Psiphon赛风VPN（30个国家）分流功能。Hostuno三合一代理脚本
- [`ermaozi/get_subscribe`](https://github.com/ermaozi/get_subscribe) ★8054 — *Python* — _ermaozi_
  
  > ✈️ 白嫖免费机场  / 免费VPN -> 自动获取免 clash/v2ray/trojan/sr/ssr 订阅链接，持续更新 | 科学上网 | 翻墙

## 📂 interesting (19 Repos)

- [`bee-san/Ciphey`](https://github.com/bee-san/Ciphey) ★19838 — *Python* — _bee-san_
...
- [`HuLaSpark/HuLa`](https://github.com/HuLaSpark/HuLa) ★3580 — *Vue* — _HuLaSpark_
  ...
  > 🍀HuLa is a cross-platform instant messaging desktop application based on Tauri v2+Vue3, compatible with Windows, MacOS, Linux, Android, IOS  （HuLa是一款基于Tauri v2+Vue3的跨平台即时通讯桌面应用，兼容Windows、MacOS、Linux、Android、IOS）
- [`TapXWorld/ChinaTextbook`](https://github.com/TapXWorld/ChinaTextbook) ★47465 — *Roff* — _TapXWorld_
  
  > 所有小初高、大学PDF教材。
- [`duplicati/duplicati`](https://github.com/duplicati/duplicati) ★13032 — *C#* — _duplicati_
  
  > Store securely encrypted backups in the cloud!
- [`cuixueshe/earthworm`](https://github.com/cuixueshe/earthworm) ★9299 — *TypeScript* — _cuixueshe_
...
- [`ayangweb/BongoCat`](https://github.com/ayangweb/BongoCat) ★9551 — *TypeScript* — _ayangweb_
  ...
  > 🐱 跨平台桌宠 BongoCat，为桌面增添乐趣！
- [`Anduin2017/HowToCook`](https://github.com/Anduin2017/HowToCook) ★92599 — *Dockerfile* — _Anduin2017_
  
  > 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
- [`Cute-Dress/Dress`](https://github.com/Cute-Dress/Dress) ★1612 — *Ruby* — _Cute-Dress_
...
- [`community/community`](https://github.com/community/community) ★7472 — *Ruby* — _community_
...
- [`keleus/BewlyCat`](https://github.com/keleus/BewlyCat) ★660 — *Vue* — _keleus_
  ...
  > BewlyCat——基于BewlyBewly开发的Bilibili拓展
- [`MlgmXyysd/Xiaomi-BootLoader-Questionnaire`](https://github.com/MlgmXyysd/Xiaomi-BootLoader-Questionnaire) ★4226 — *None* — _MlgmXyysd_
...
- [`tailscale/tailscale`](https://github.com/tailscale/tailscale) ★24348 — *Go* — _tailscale_
  
  > The easiest, most secure way to use WireGuard and 2FA.

## 📂 Linux (30 Repos)

- [`kholia/OSX-KVM`](https://github.com/kholia/OSX-KVM) ★22116 — *Python* — _kholia_
...
- [`SuperManito/LinuxMirrors`](https://github.com/SuperManito/LinuxMirrors) ★5338 — *Shell* — _SuperManito_
  
  > GNU/Linux 更换系统软件源脚本及 Docker 安装与换源脚本
- [`duplicati/duplicati`](https://github.com/duplicati/duplicati) ★13032 — *C#* — _duplicati_
  
  > Store securely encrypted backups in the cloud!
- [`Lxtharia/minegrub-world-sel-theme`](https://github.com/Lxtharia/minegrub-world-sel-theme) ★561 — *Nix* — _Lxtharia_
  
  > A grub theme in the style of the Minecraft singleplayer (sp) world selection screen!
- [`LazyVim/starter`](https://github.com/LazyVim/starter) ★1476 — *Lua* — _LazyVim_
  
  > Starter template for LazyVim
- [`LazyVim/LazyVim`](https://github.com/LazyVim/LazyVim) ★22146 — *Lua* — _LazyVim_
  
  > Neovim config for the lazy
- [`PintaProject/Pinta`](https://github.com/PintaProject/Pinta) ★2823 — *C#* — _PintaProject_
...
- [`ruffle-rs/ruffle`](https://github.com/ruffle-rs/ruffle) ★17092 — *Rust* — _ruffle-rs_
  ...
  > A Flash Player emulator written in Rust
- [`vim/vim`](https://github.com/vim/vim) ★38804 — *Vim Script* — _vim_
...
- [`pterodactyl-china/panel`](https://github.com/pterodactyl-china/panel) ★250 — *PHP* — _pterodactyl-china_
  ...
  > 【翼龙面板汉化版】Pterodactyl®的中文汉化并国内本土化版本，并实时更新主分支的dev内容。
- [`201206030/novel-plus`](https://github.com/201206030/novel-plus) ★4225 — *Java* — _201206030_
  
  > novel-plus 是一个多端（PC、WAP）阅读 、功能完善的小说 CMS 系统。包括小说推荐、小说检索、小说排行、小说阅读、小说书架、小说评论、小说爬虫、会员中心、作家专区、充值订阅、新闻发布等功能。
- [`TWO-ICE/Awesome-NAS-Docker`](https://github.com/TWO-ICE/Awesome-NAS-Docker) ★1664 — *None* — _TWO-ICE_
...
- [`zizmorcore/zizmor`](https://github.com/zizmorcore/zizmor) ★2918 — *Rust* — _zizmorcore_
  
  > Static analysis for GitHub Actions
- [`weepwood/Sync-Bangumi-to-Notion`](https://github.com/weepwood/Sync-Bangumi-to-Notion) ★1 — *Python* — _weepwood_
- [`nektos/act`](https://github.com/nektos/act) ★65226 — *Go* — _nektos_
  
  > Run your GitHub Actions locally 🚀
- [`actions/setup-python`](https://github.com/actions/setup-python) ★1961 — *TypeScript* — _actions_
...
- [`anuraghazra/github-readme-stats`](https://github.com/anuraghazra/github-readme-stats) ★75146 — *JavaScript* — _anuraghazra_
...
- [`Karben233/bili-hardcore`](https://github.com/Karben233/bili-hardcore) ★1220 — *Python* — _Karben233_
...
- [`mozilla-firefox/firefox`](https://github.com/mozilla-firefox/firefox) ★9751 — *JavaScript* — _mozilla-firefox_
  
  > The official repository of Mozilla's Firefox web browser.
- [`dudor/BookmarkHub`](https://github.com/dudor/BookmarkHub) ★1819 — *TypeScript* — _dudor_
  
  > BookmarkHub , sync bookmarks across different browsers
- [`floccusaddon/floccus`](https://github.com/floccusaddon/floccus) ★6953 — *JavaScript* — _floccusaddon_
...
- [`hoothin/UserScripts`](https://github.com/hoothin/UserScripts) ★3738 — *JavaScript* — _hoothin_
  
  > Greasemonkey scripts ( Pagetual / Picviewer CE+ / DownloadAllContent ) 油猴腳本集 ユーザースクリプト集
- [`zen-browser/desktop`](https://github.com/zen-browser/desktop) ★35338 — *C++* — _zen-browser_
...
- [`giscus/giscus`](https://github.com/giscus/giscus) ★10341 — *TypeScript* — _giscus_
...
- [`weepwood/Sync-Bangumi-to-Notion`](https://github.com/weepwood/Sync-Bangumi-to-Notion) ★1 — *Python* — _weepwood_
- [`utterance/utterances`](https://github.com/utterance/utterances) ★9433 — *TypeScript* — _utterance_
  
  > :crystal_ball: A lightweight comments widget built on GitHub issues
- [`craigary/nobelium`](https://github.com/craigary/nobelium) ★3119 — *JavaScript* — _craigary_
  
  > A static blog build on top of Notion and NextJS, deployed on Vercel.
- [`tangly1024/NotionNext`](https://github.com/tangly1024/NotionNext) ★10018 — *JavaScript* — _tangly1024_
...
- [`runjuu/InputSourcePro`](https://github.com/runjuu/InputSourcePro) ★2064 — *Swift* — _runjuu_
  
  > Switch and track your input sources with ease ✨
- [`noah-nuebling/mac-mouse-fix`](https://github.com/noah-nuebling/mac-mouse-fix) ★7672 — *Objective-C* — _noah-nuebling_
...
- [`YanG-1989/m3u`](https://github.com/YanG-1989/m3u) ★9475 — *Shell* — _YanG-1989_
...
- [`liu673cn/bug`](https://github.com/liu673cn/bug) ★10558 — *HTML* — _liu673cn_
  ...
  > TVbox开源版（空壳-自行配置）
- [`suxuang/myIPTV`](https://github.com/suxuang/myIPTV) ★3201 — *None* — _suxuang_
  
  > 【典藏版】高清直播源涵盖几乎所有卫视节目，内置完美台标加节目预告
- [`scovis/TVBox`](https://github.com/scovis/TVBox) ★881 — *None* — _scovis_
