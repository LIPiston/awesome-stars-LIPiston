...
- [`Heavrnl/nexus-terminal`](https://github.com/Heavrnl/nexus-terminal) ★1350 — *TypeScript* — _Heavrnl_
  
  > 一款现代化的 Web SSH / RDP / VNC 客户端，提供独立桌面端，支持人机验证、2FA、界面定制、操作审计等强大功能。
- [`LibreSpark/LibreTV`](https://github.com/LibreSpark/LibreTV) ★11147 — *JavaScript* — _LibreSpark_
  
  > 一分钟搭建影视站，支持Vercel/Docker等部署方式
- [`VERT-sh/VERT`](https://github.com/VERT-sh/VERT) ★5276 — *Svelte* — _VERT-sh_
...
- [`zed-industries/zed`](https://github.com/zed-industries/zed) ★64290 — *Rust* — _zed-industries_
...
- [`ccbikai/Sink`](https://github.com/ccbikai/Sink) ★5135 — *Vue* — _ccbikai_
  
  > ⚡ A Simple / Speedy / Secure Link Shortener with Analytics, 100% run on Cloudflare.
- [`ciiiii/cloudflare-docker-proxy`](https://github.com/ciiiii/cloudflare-docker-proxy) ★1826 — *JavaScript* — _ciiiii_
...
- [`ruffle-rs/ruffle`](https://github.com/ruffle-rs/ruffle) ★17102 — *Rust* — _ruffle-rs_
  
  > A Flash Player emulator written in Rust
- [`moeyy01/gh-proxy-go`](https://github.com/moeyy01/gh-proxy-go) ★145 — *Go* — _moeyy01_
- [`yonggekkk/warp-yg`](https://github.com/yonggekkk/warp-yg) ★4060 — *Shell* — _yonggekkk_
  
  > warp多功能一键脚本，支持warp-go与wgcf切换，无限生成warp配置文件，支持升级warp+、warp团队账户，查看VPS本地IP、netflix、chatgpt解锁状态
- [`cmj2002/warp-docker`](https://github.com/cmj2002/warp-docker) ★625 — *Shell* — _cmj2002_
  
  > Run Cloudflare WARP in Docker.
- [`MarSeventh/CloudFlare-ImgBed`](https://github.com/MarSeventh/CloudFlare-ImgBed) ★2859 — *JavaScript* — _MarSeventh_
...
- [`oiov/wr.do`](https://github.com/oiov/wr.do) ★1848 — *TypeScript* — _oiov_
  
  > 一站式域名服务平台，集成短链生成、无限域名邮箱、文件存储和子域名管理，带有管理员面板，支持自部署
- [`scriptscat/scriptcat`](https://github.com/scriptscat/scriptcat) ★3313 — *TypeScript* — _scriptscat_
  
  > ScriptCat, a browser extension that can execute userscript; 脚本猫，一个可以执行用户脚本的浏览器扩展

## 📂 Windows工具 (22 Repos)

- [`ShadowWhisperer/Remove-MS-Edge`](https://github.com/ShadowWhisperer/Remove-MS-Edge) ★4110 — *Python* — _ShadowWhisperer_
...
- [`liriliri/aya`](https://github.com/liriliri/aya) ★3553 — *TypeScript* — _liriliri_
  
  > Android ADB desktop app
- [`maotoumao/MusicFree`](https://github.com/maotoumao/MusicFree) ★19860 — *TypeScript* — _maotoumao_
  
  > 插件化、定制化、无广告的免费音乐播放器
- [`microsoft/WSL`](https://github.com/microsoft/WSL) ★29629 — *C++* — _microsoft_
  
  > Windows Subsystem for Linux
- [`LGUG2Z/komorebi`](https://github.com/LGUG2Z/komorebi) ★12417 — *Rust* — _LGUG2Z_
  
  > A tiling window manager for Windows 🍉
- [`saber-notes/saber`](https://github.com/saber-notes/saber) ★3518 — *Dart* — _saber-notes_
  
  > The cross-platform open-source app built for handwriting
- [`rcmaehl/MSEdgeRedirect`](https://github.com/rcmaehl/MSEdgeRedirect) ★5177 — *AutoIt* — _rcmaehl_
  
  > A Tool to Redirect News, Search, Widgets, Weather and More to Your Default Browser
- [`MustardChef/WSABuilds`](https://github.com/MustardChef/WSABuilds) ★11208 — *Python* — _MustardChef_
...
- [`ayangweb/BongoCat`](https://github.com/ayangweb/BongoCat) ★9625 — *TypeScript* — _ayangweb_
...
- [`keleus/BewlyCat`](https://github.com/keleus/BewlyCat) ★734 — *Vue* — _keleus_
...
- [`mgth/LittleBigMouse`](https://github.com/mgth/LittleBigMouse) ★4803 — *C#* — _mgth_
  
  > DPI Aware mouse move across screens
- [`tom-snow/wechat-windows-versions`](https://github.com/tom-snow/wechat-windows-versions) ★2449 — *Shell* — _tom-snow_
  
  > 保存微信历史版本
- [`MeowCracker/MobaGenkey`](https://github.com/MeowCracker/MobaGenkey) ★4 — *HTML* — _MeowCracker_
  
  > 一个 MobaXterm 的许可证生成器
- [`mulaRahul/keyviz`](https://github.com/mulaRahul/keyviz) ★8053 — *Dart* — _mulaRahul_
  
  > Keyviz is a free and open-source tool to visualize your keystrokes ⌨️ and 🖱️ mouse actions in real-time.
- [`yoopta-editor/Yoopta-Editor`](https://github.com/yoopta-editor/Yoopta-Editor) ★2417 — *TypeScript* — _yoopta-editor_
  
  > Build Notion-like, Craft-like, Coda-like, Medium-like editors with Yoopta

## 📂 安卓app (17 Repos)

- [`AChep/keyguard-app`](https://github.com/AChep/keyguard-app) ★1964 — *Kotlin* — _AChep_
...
- [`saber-notes/saber`](https://github.com/saber-notes/saber) ★3518 — *Dart* — _saber-notes_
  ...
  > The cross-platform open-source app built for handwriting
- [`lz233/Tarnhelm`](https://github.com/lz233/Tarnhelm) ★637 — *Kotlin* — _lz233_
  
  > The magic to clean sharing links up.
- [`algerkong/AlgerMusicPlayer`](https://github.com/algerkong/AlgerMusicPlayer) ★10670 — *Vue* — _algerkong_
...
- [`JunkFood02/Seal`](https://github.com/JunkFood02/Seal) ★21342 — *Kotlin* — _JunkFood02_
  
  > 🦭 Video/Audio Downloader for Android, based on yt-dlp, designed with Material You
- [`guozhigq/pilipala`](https://github.com/guozhigq/pilipala) ★12322 — *Dart* — _guozhigq_
...
- [`hongchacha/cartoon`](https://github.com/hongchacha/cartoon) ★2436 — *None* — _hongchacha_
  ...
  > 全是漫画，免费漫画app
- [`youniaogu/MangaReader`](https://github.com/youniaogu/MangaReader) ★2393 — *TypeScript* — _youniaogu_
  
  > 一个漫画 APP📱，基于 react-native 构建，兼容 Android、Ios 平台
- [`wxxsfxyzm/InstallerX-Revived`](https://github.com/wxxsfxyzm/InstallerX-Revived) ★777 — *Kotlin* — _wxxsfxyzm_
  
  > More Expressive InstallerX !
- [`vvb2060/PackageInstaller`](https://github.com/vvb2060/PackageInstaller) ★338 — *Kotlin* — _vvb2060_
...
- [`Textualize/textual`](https://github.com/Textualize/textual) ★30626 — *Python* — _Textualize_
...
- [`juliangarnier/anime`](https://github.com/juliangarnier/anime) ★63354 — *JavaScript* — _juliangarnier_
...
- [`NervJS/taro`](https://github.com/NervJS/taro) ★36840 — *TypeScript* — _NervJS_
  
  > 开放式跨端跨框架解决方案，支持使用 React/Vue 等框架来开发微信/京东/百度/支付宝/字节跳动/ QQ 小程序/H5/React Native 等应用。  https://taro.zone/
- [`tauri-apps/tauri`](https://github.com/tauri-apps/tauri) ★95870 — *Rust* — _tauri-apps_
  
  > Build smaller, faster, and more secure desktop and mobile applications with a web frontend.
- [`mitesh77/Best-Flutter-UI-Templates`](https://github.com/mitesh77/Best-Flutter-UI-Templates) ★21959 — *Dart* — _mitesh77_
  
  > completely free for everyone. Its build-in Flutter Dart.
- [`fail2ban/fail2ban`](https://github.com/fail2ban/fail2ban) ★15253 — *Python* — _fail2ban_
  
  > Daemon to ban hosts that cause multiple authentication errors
- [`fuma-nama/fumadocs`](https://github.com/fuma-nama/fumadocs) ★7790 — *TypeScript* — _fuma-nama_
  
  > The beautiful docs framework with Next.js and any React.js framework.
- [`vuetifyjs/vuetify`](https://github.com/vuetifyjs/vuetify) ★40694 — *TypeScript* — _vuetifyjs_
  
  > 🐉 Vue Component Framework
- [`tusen-ai/naive-ui`](https://github.com/tusen-ai/naive-ui) ★17579 — *TypeScript* — _tusen-ai_
  
  > A Vue 3 Component Library. Fairly Complete. Theme Customizable. Uses TypeScript. Fast.
- [`Nuitka/Nuitka`](https://github.com/Nuitka/Nuitka) ★13673 — *Python* — _Nuitka_
  
  > Nuitka is a Python compiler written in Python.  It's fully compatible with Python 2.6, 2.7, 3.4-3.13. You feed it your Python app, it does a lot of clever things, and spits out an executable or extension module.
- [`zhiyiYo/PyQt-Fluent-Widgets`](https://github.com/zhiyiYo/PyQt-Fluent-Widgets) ★7037 — *Python* — _zhiyiYo_
  
  > A fluent design widgets library based on C++ Qt/PyQt/PySide. Make Qt Great Again.
- [`duckdb/duckdb`](https://github.com/duckdb/duckdb) ★32250 — *C++* — _duckdb_
...
- [`google-gemini/gemini-cli`](https://github.com/google-gemini/gemini-cli) ★71422 — *TypeScript* — _google-gemini_
  
  > An open-source AI agent that brings the power of Gemini directly into your terminal.
- [`qd-today/qd`](https://github.com/qd-today/qd) ★5087 — *Python* — _qd-today_
  
  > QD [v20240210] —— HTTP请求定时任务自动执行框架 base on HAR Editor and Tornado Server
- [`coracoo/awesome_docker_cn`](https://github.com/coracoo/awesome_docker_cn) ★2423 — *None* — _coracoo_
  
  > 上百款可docker部署的项目，包含项目地址、项目部署教程等。
- [`veggiemonk/awesome-docker`](https://github.com/veggiemonk/awesome-docker) ★33423 — *None* — _veggiemonk_
  
  > :whale: A curated list of Docker resources and projects
- [`jellyfin/jellyfin`](https://github.com/jellyfin/jellyfin) ★42868 — *C#* — _jellyfin_
  
  > The Free Software Media System - Server Backend & API
- [`halo-dev/halo`](https://github.com/halo-dev/halo) ★36656 — *Java* — _halo-dev_
  
  > 强大易用的开源建站工具。
- [`NginxProxyManager/nginx-proxy-manager`](https://github.com/NginxProxyManager/nginx-proxy-manager) ★28137 — *JavaScript* — _NginxProxyManager_
...
- [`Pumpkin-MC/Pumpkin`](https://github.com/Pumpkin-MC/Pumpkin) ★5438 — *Rust* — _Pumpkin-MC_
...
- [`groupultra/telegram-search`](https://github.com/groupultra/telegram-search) ★2787 — *TypeScript* — _groupultra_
...
- [`AstrBotDevs/AstrBot`](https://github.com/AstrBotDevs/AstrBot) ★11647 — *Python* — _AstrBotDevs_
  
  > ✨ 易上手的多平台 LLM 聊天机器人及开发框架 ✨ 支持 QQ、QQ频道、Telegram、企微、飞书、钉钉 | 知识库、MCP 服务器、OpenAI、DeepSeek、Gemini、硅基流动、月之暗面、Ollama、OneAPI、Dify
- [`koishijs/koishi`](https://github.com/koishijs/koishi) ★5175 — *TypeScript* — _koishijs_
...
- [`chenzyadb/CuprumTurbo-Scheduler`](https://github.com/chenzyadb/CuprumTurbo-Scheduler) ★401 — *Shell* — _chenzyadb_
...
- [`KernelSU-Next/KernelSU-Next`](https://github.com/KernelSU-Next/KernelSU-Next) ★2247 — *Kotlin* — _KernelSU-Next_
...
- [`themepark-dev/theme.park`](https://github.com/themepark-dev/theme.park) ★2871 — *CSS* — _themepark-dev_
  
  > A collection of themes/skins for 50 selfhosted apps!

## 📂 VSCode (4 Repos)

- [`voideditor/void`](https://github.com/voideditor/void) ★26720 — *TypeScript* — _voideditor_
- [`yeongpin/cursor-free-vip`](https://github.com/yeongpin/cursor-free-vip) ★34745 — *Python* — _yeongpin_
  
  > [Support 0.49.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
- [`artisticat1/obsidian-latex-suite`](https://github.com/artisticat1/obsidian-latex-suite) ★1943 — *TypeScript* — _artisticat1_
...
- [`goto456/stopwords`](https://github.com/goto456/stopwords) ★5262 — *None* — _goto456_
  
  > 中文常用停用词表（哈工大停用词表、百度停用词表等）
- [`brightmart/nlp_chinese_corpus`](https://github.com/brightmart/nlp_chinese_corpus) ★9773 — *None* — _brightmart_
...
- [`krillinai/KlicStudio`](https://github.com/krillinai/KlicStudio) ★8345 — *Go* — _krillinai_
...
- [`comfyanonymous/ComfyUI`](https://github.com/comfyanonymous/ComfyUI) ★86395 — *Python* — _comfyanonymous_
  
  > The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
- ⚠️ Repo ID `983303900` not found in data.json.
- [`browser-use/workflow-use`](https://github.com/browser-use/workflow-use) ★3663 — *TypeScript* — _browser-use_
  
  > ⚙️ Create and run workflows (RPA 2.0)
- [`punkpeye/awesome-mcp-servers`](https://github.com/punkpeye/awesome-mcp-servers) ★67076 — *None* — _punkpeye_
  
  > A collection of MCP servers.
- [`xming521/WeClone`](https://github.com/xming521/WeClone) ★15371 — *Python* — _xming521_
...
- [`simular-ai/Agent-S`](https://github.com/simular-ai/Agent-S) ★6166 — *Python* — _simular-ai_
  
  > Agent S: an open agentic framework that uses computers like a human
- [`x1xhlol/system-prompts-and-models-of-ai-tools`](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) ★78510 — *None* — _x1xhlol_
...
- [`hacksider/Deep-Live-Cam`](https://github.com/hacksider/Deep-Live-Cam) ★72675 — *Python* — _hacksider_
  
  > real time face swap and one-click video deepfake with only a single image
- [`yeongpin/cursor-free-vip`](https://github.com/yeongpin/cursor-free-vip) ★34745 — *Python* — _yeongpin_
  
  > [Support 0.49.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
- [`chatanywhere/GPT_API_free`](https://github.com/chatanywhere/GPT_API_free) ★31852 — *Python* — _chatanywhere_
...
- [`github/github-mcp-server`](https://github.com/github/github-mcp-server) ★21587 — *Go* — _github_
...
- [`pagefaultgames/pokerogue`](https://github.com/pagefaultgames/pokerogue) ★5312 — *TypeScript* — _pagefaultgames_
  
  > A browser based Pokémon fangame heavily inspired by the roguelite genre.
- [`libnoname/noname`](https://github.com/libnoname/noname) ★3755 — *JavaScript* — _libnoname_
...
- [`1995chen/dnf`](https://github.com/1995chen/dnf) ★1509 — *Shell* — _1995chen_

## 📂 proxy (5 Repos)

- [`fscarmen/ArgoX`](https://github.com/fscarmen/ArgoX) ★1496 — *Shell* — _fscarmen_
  
  > Argo Xray for VPS one-click script. 一键脚本
- [`frankiejun/serv00-play`](https://github.com/frankiejun/serv00-play) ★2126 — *Shell* — _frankiejun_
  
  > serv00/hostuno 上的一些应用，包括argo+vmess/vmess+ws/hy2/socks5/mtproto/alist/哪吒探针|面板 等, 自动化部署、批量保号、进程防杀、消息推送
- [`eooce/Sing-box`](https://github.com/eooce/Sing-box) ★3139 — *Shell* — _eooce_
...
- [`yonggekkk/sing-box-yg`](https://github.com/yonggekkk/sing-box-yg) ★5174 — *Shell* — _yonggekkk_
  
  > Sing-box精装桶四合一协议VPS专用脚本：三大独家功能！自签/acme双证书切换、Argo固定临时双隧道（可共存）、Psiphon赛风VPN（30个国家）分流功能。Hostuno三合一代理脚本
- [`ermaozi/get_subscribe`](https://github.com/ermaozi/get_subscribe) ★8060 — *Python* — _ermaozi_
  
  > ✈️ 白嫖免费机场  / 免费VPN -> 自动获取免 clash/v2ray/trojan/sr/ssr 订阅链接，持续更新 | 科学上网 | 翻墙

## 📂 interesting (19 Repos)

- [`bee-san/Ciphey`](https://github.com/bee-san/Ciphey) ★19849 — *Python* — _bee-san_
  
  > ⚡ Automatically decrypt encryptions without knowing the key or cipher, decode encodings, and crack hashes ⚡
- [`hmjz100/123panYouthMember`](https://github.com/hmjz100/123panYouthMember) ★513 — *JavaScript* — _hmjz100_
  
  > 123 云盘会员青春版 - 在 123 云盘超过 1GB 上限下载文件，显示身份信息为会员；123 云盘下载辅助增强脚本 - 123云盘 - 用户脚本 - “解锁”123云盘下载
- [`HuLaSpark/HuLa`](https://github.com/HuLaSpark/HuLa) ★3590 — *Vue* — _HuLaSpark_
  
  > 🍀HuLa is a cross-platform instant messaging desktop application based on Tauri v2+Vue3, compatible with Windows, MacOS, Linux, Android, IOS  （HuLa是一款基于Tauri v2+Vue3的跨平台即时通讯桌面应用，兼容Windows、MacOS、Linux、Android、IOS）
- [`TapXWorld/ChinaTextbook`](https://github.com/TapXWorld/ChinaTextbook) ★47575 — *Roff* — _TapXWorld_
  
  > 所有小初高、大学PDF教材。
- [`duplicati/duplicati`](https://github.com/duplicati/duplicati) ★13053 — *C#* — _duplicati_
  
  > Store securely encrypted backups in the cloud!
- [`cuixueshe/earthworm`](https://github.com/cuixueshe/earthworm) ★9315 — *TypeScript* — _cuixueshe_
...
- [`ayangweb/BongoCat`](https://github.com/ayangweb/BongoCat) ★9625 — *TypeScript* — _ayangweb_
  ...
  > 🐱 跨平台桌宠 BongoCat，为桌面增添乐趣！
- [`Anduin2017/HowToCook`](https://github.com/Anduin2017/HowToCook) ★92759 — *Dockerfile* — _Anduin2017_
  
  > 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
- [`Cute-Dress/Dress`](https://github.com/Cute-Dress/Dress) ★1614 — *Ruby* — _Cute-Dress_
...
- [`community/community`](https://github.com/community/community) ★7480 — *Ruby* — _community_
...
- [`keleus/BewlyCat`](https://github.com/keleus/BewlyCat) ★734 — *Vue* — _keleus_
  ...
  > BewlyCat——基于BewlyBewly开发的Bilibili拓展
- [`MlgmXyysd/Xiaomi-BootLoader-Questionnaire`](https://github.com/MlgmXyysd/Xiaomi-BootLoader-Questionnaire) ★4230 — *None* — _MlgmXyysd_
...
- [`tailscale/tailscale`](https://github.com/tailscale/tailscale) ★24393 — *Go* — _tailscale_
  
  > The easiest, most secure way to use WireGuard and 2FA.

## 📂 Linux (30 Repos)

- [`kholia/OSX-KVM`](https://github.com/kholia/OSX-KVM) ★22123 — *Python* — _kholia_
...
- [`SuperManito/LinuxMirrors`](https://github.com/SuperManito/LinuxMirrors) ★5353 — *Shell* — _SuperManito_
  
  > GNU/Linux 更换系统软件源脚本及 Docker 安装与换源脚本
- [`duplicati/duplicati`](https://github.com/duplicati/duplicati) ★13053 — *C#* — _duplicati_
  
  > Store securely encrypted backups in the cloud!
- [`Lxtharia/minegrub-world-sel-theme`](https://github.com/Lxtharia/minegrub-world-sel-theme) ★565 — *Nix* — _Lxtharia_
...
- [`LazyVim/LazyVim`](https://github.com/LazyVim/LazyVim) ★22184 — *Lua* — _LazyVim_
...
- [`ruffle-rs/ruffle`](https://github.com/ruffle-rs/ruffle) ★17102 — *Rust* — _ruffle-rs_
  ...
  > A Flash Player emulator written in Rust
- [`vim/vim`](https://github.com/vim/vim) ★38817 — *Vim Script* — _vim_
...
- [`TWO-ICE/Awesome-NAS-Docker`](https://github.com/TWO-ICE/Awesome-NAS-Docker) ★1702 — *None* — _TWO-ICE_
...
- [`nektos/act`](https://github.com/nektos/act) ★65297 — *Go* — _nektos_
  
  > Run your GitHub Actions locally 🚀
- [`actions/setup-python`](https://github.com/actions/setup-python) ★1964 — *TypeScript* — _actions_
...
- [`yoshi389111/github-profile-3d-contrib`](https://github.com/yoshi389111/github-profile-3d-contrib) ★1370 — *TypeScript* — _yoshi389111_
...
- [`anuraghazra/github-readme-stats`](https://github.com/anuraghazra/github-readme-stats) ★75261 — *JavaScript* — _anuraghazra_
...
- [`guozhigq/pilipala`](https://github.com/guozhigq/pilipala) ★12322 — *Dart* — _guozhigq_
  ...
  > PiliPala 是使用Flutter开发的BiliBili第三方客户端，感谢使用。
- [`AHCorn/Bilibili-Auto-Quality`](https://github.com/AHCorn/Bilibili-Auto-Quality) ★373 — *JavaScript* — _AHCorn_
...
- [`Karben233/bili-hardcore`](https://github.com/Karben233/bili-hardcore) ★1223 — *Python* — _Karben233_
...
- [`mozilla-firefox/firefox`](https://github.com/mozilla-firefox/firefox) ★9766 — *JavaScript* — _mozilla-firefox_
  
  > The official repository of Mozilla's Firefox web browser.
- [`dudor/BookmarkHub`](https://github.com/dudor/BookmarkHub) ★1834 — *TypeScript* — _dudor_
...
- [`hoothin/UserScripts`](https://github.com/hoothin/UserScripts) ★3741 — *JavaScript* — _hoothin_
  
  > Greasemonkey scripts ( Pagetual / Picviewer CE+ / DownloadAllContent ) 油猴腳本集 ユーザースクリプト集
- [`zen-browser/desktop`](https://github.com/zen-browser/desktop) ★35423 — *C++* — _zen-browser_
...
- [`weepwood/Sync-Bangumi-to-Notion`](https://github.com/weepwood/Sync-Bangumi-to-Notion) ★1 — *Python* — _weepwood_
- [`utterance/utterances`](https://github.com/utterance/utterances) ★9439 — *TypeScript* — _utterance_
  
  > :crystal_ball: A lightweight comments widget built on GitHub issues
- [`craigary/nobelium`](https://github.com/craigary/nobelium) ★3120 — *JavaScript* — _craigary_
  
  > A static blog build on top of Notion and NextJS, deployed on Vercel.
- [`tangly1024/NotionNext`](https://github.com/tangly1024/NotionNext) ★10047 — *JavaScript* — _tangly1024_
...
- [`runjuu/InputSourcePro`](https://github.com/runjuu/InputSourcePro) ★2090 — *Swift* — _runjuu_
  
  > Switch and track your input sources with ease ✨
- [`noah-nuebling/mac-mouse-fix`](https://github.com/noah-nuebling/mac-mouse-fix) ★7681 — *Objective-C* — _noah-nuebling_
...
- [`YanG-1989/m3u`](https://github.com/YanG-1989/m3u) ★9499 — *Shell* — _YanG-1989_
  
  > 直播源
- [`Archmage83/Android_apk`](https://github.com/Archmage83/Android_apk) ★361 — *None* — _Archmage83_
  
  > 手机安卓手机端电影软件，希望大家一起维护
- [`liu673cn/bug`](https://github.com/liu673cn/bug) ★10557 — *HTML* — _liu673cn_
  
  > TVbox开源版（空壳-自行配置）
- [`suxuang/myIPTV`](https://github.com/suxuang/myIPTV) ★3216 — *None* — _suxuang_
  
  > 【典藏版】高清直播源涵盖几乎所有卫视节目，内置完美台标加节目预告
- [`scovis/TVBox`](https://github.com/scovis/TVBox) ★889 — *None* — _scovis_
