...
- [`Heavrnl/nexus-terminal`](https://github.com/Heavrnl/nexus-terminal) ★949 — *TypeScript* — _Heavrnl_
  
  > 一款现代化的 Web SSH / RDP / VNC 客户端，提供独立桌面端，支持人机验证、2FA、界面定制、操作审计等强大功能。
- [`LibreSpark/LibreTV`](https://github.com/LibreSpark/LibreTV) ★5362 — *JavaScript* — _LibreSpark_
  
  > 一分钟搭建影视站，支持Vercel/Docker等部署方式
- [`VERT-sh/VERT`](https://github.com/VERT-sh/VERT) ★4575 — *Svelte* — _VERT-sh_
  
  > The next-generation file converter. Open source, fully local* and free forever.
- [`1234567Yang/cf-proxy-ex`](https://github.com/1234567Yang/cf-proxy-ex) ★1454 — *JavaScript* — _1234567Yang_
...
- [`zed-industries/zed`](https://github.com/zed-industries/zed) ★61086 — *Rust* — _zed-industries_
...
- [`ciiiii/cloudflare-docker-proxy`](https://github.com/ciiiii/cloudflare-docker-proxy) ★1761 — *JavaScript* — _ciiiii_
...
- [`wekan/wekan`](https://github.com/wekan/wekan) ★20365 — *JavaScript* — _wekan_
...
- [`ruffle-rs/ruffle`](https://github.com/ruffle-rs/ruffle) ★16746 — *Rust* — _ruffle-rs_
...
- [`MarSeventh/CloudFlare-ImgBed`](https://github.com/MarSeventh/CloudFlare-ImgBed) ★2185 — *JavaScript* — _MarSeventh_
...
- [`oiov/wr.do`](https://github.com/oiov/wr.do) ★1194 — *TypeScript* — _oiov_
  
  > 📧🔗🌏 Shorten links with analytics, manage emails and control subdomains—all on one platform.

## 📂 Windows工具 (20 Repos)

- [`ShadowWhisperer/Remove-MS-Edge`](https://github.com/ShadowWhisperer/Remove-MS-Edge) ★3460 — *Python* — _ShadowWhisperer_
  
  > Uninstall Microsoft Edge silently, through an executable or batch script.
- [`jark006/jarkViewer`](https://github.com/jark006/jarkViewer) ★365 — *C++* — _jark006_
  
  > A simple image viewer. 一款简单的看图软件。
- [`liriliri/aya`](https://github.com/liriliri/aya) ★2778 — *TypeScript* — _liriliri_
  
  > Android ADB desktop app
- [`maotoumao/MusicFree`](https://github.com/maotoumao/MusicFree) ★16576 — *TypeScript* — _maotoumao_
  
  > 插件化、定制化、无广告的免费音乐播放器
- [`microsoft/WSL`](https://github.com/microsoft/WSL) ★28288 — *C++* — _microsoft_
  
  > Windows Subsystem for Linux
- [`LGUG2Z/komorebi`](https://github.com/LGUG2Z/komorebi) ★11686 — *Rust* — _LGUG2Z_
  
  > A tiling window manager for Windows 🍉
- [`saber-notes/saber`](https://github.com/saber-notes/saber) ★3298 — *Dart* — _saber-notes_
  
  > The cross-platform open-source app built for handwriting
- [`rcmaehl/MSEdgeRedirect`](https://github.com/rcmaehl/MSEdgeRedirect) ★4685 — *AutoIt* — _rcmaehl_
  
  > A Tool to Redirect News, Search, Widgets, Weather and More to Your Default Browser
- [`MustardChef/WSABuilds`](https://github.com/MustardChef/WSABuilds) ★10246 — *Python* — _MustardChef_
  
  > Run Windows Subsystem For Android on your Windows 10 and Windows 11 PC using prebuilt binaries with Google Play Store (MindTheGapps) and/or Magisk or KernelSU (root solutions) built in.
- [`HuLaSpark/HuLa`](https://github.com/HuLaSpark/HuLa) ★2977 — *Vue* — _HuLaSpark_
  
  > 🍀 HuLa是一款基于Tauri v2+Vue3的跨平台即时通讯桌面应用（不仅仅是即时通讯），兼容Windows、MacOS、Linux、Android、IOS
- [`duplicati/duplicati`](https://github.com/duplicati/duplicati) ★12665 — *C#* — _duplicati_
  
  > Store securely encrypted backups in the cloud!
- [`ayangweb/BongoCat`](https://github.com/ayangweb/BongoCat) ★6419 — *TypeScript* — _ayangweb_
...
- [`keleus/BewlyCat`](https://github.com/keleus/BewlyCat) ★269 — *Vue* — _keleus_
...
- [`tom-snow/wechat-windows-versions`](https://github.com/tom-snow/wechat-windows-versions) ★2206 — *Shell* — _tom-snow_
...
- [`algerkong/AlgerMusicPlayer`](https://github.com/algerkong/AlgerMusicPlayer) ★6624 — *Vue* — _algerkong_
  
  > 一个第三方音乐播放器、本地服务、桌面歌词、音乐下载、远程控制
- [`WuDi-ZhanShen/ShizukuRunner`](https://github.com/WuDi-ZhanShen/ShizukuRunner) ★218 — *Java* — _WuDi-ZhanShen_
  
  > 以shizuku身份执行命令的安卓小工具。A 50KB android app to run any commands via Shizuku.
- [`JunkFood02/Seal`](https://github.com/JunkFood02/Seal) ★19254 — *Kotlin* — _JunkFood02_
  
  > 🦭 Video/Audio Downloader for Android, based on yt-dlp, designed with Material You
- [`guozhigq/pilipala`](https://github.com/guozhigq/pilipala) ★10921 — *Dart* — _guozhigq_
...
- [`Textualize/textual`](https://github.com/Textualize/textual) ★29011 — *Python* — _Textualize_
  
  > The lean application framework for Python.  Build sophisticated user interfaces with a simple Python API. Run your apps in the terminal and a web browser.
- [`urwid/urwid`](https://github.com/urwid/urwid) ★2905 — *Python* — _urwid_
  
  > Console user interface library for Python (official repo)
- [`ZhuoZhuoCrayon/throttled-py`](https://github.com/ZhuoZhuoCrayon/throttled-py) ★297 — *Python* — _ZhuoZhuoCrayon_
...
- [`juliangarnier/anime`](https://github.com/juliangarnier/anime) ★61228 — *JavaScript* — _juliangarnier_
...
- [`alovajs/alova`](https://github.com/alovajs/alova) ★3623 — *TypeScript* — _alovajs_
  
  > The Request Toolkit For Ultimate Efficiency
- [`NervJS/taro`](https://github.com/NervJS/taro) ★36579 — *TypeScript* — _NervJS_
  
  > 开放式跨端跨框架解决方案，支持使用 React/Vue/Nerv 等框架来开发微信/京东/百度/支付宝/字节跳动/ QQ 小程序/H5/React Native 等应用。  https://taro.zone/
- [`tauri-apps/tauri`](https://github.com/tauri-apps/tauri) ★93306 — *Rust* — _tauri-apps_
  
  > Build smaller, faster, and more secure desktop and mobile applications with a web frontend.
- [`mitesh77/Best-Flutter-UI-Templates`](https://github.com/mitesh77/Best-Flutter-UI-Templates) ★21617 — *Dart* — _mitesh77_
  
  > completely free for everyone. Its build-in Flutter Dart.
- [`fail2ban/fail2ban`](https://github.com/fail2ban/fail2ban) ★14448 — *Python* — _fail2ban_
  
  > Daemon to ban hosts that cause multiple authentication errors
- [`fuma-nama/fumadocs`](https://github.com/fuma-nama/fumadocs) ★6692 — *TypeScript* — _fuma-nama_
  
  > The beautiful docs framework with Next.js.
- [`vuetifyjs/vuetify`](https://github.com/vuetifyjs/vuetify) ★40535 — *TypeScript* — _vuetifyjs_
  
  > 🐉 Vue Component Framework
- [`tusen-ai/naive-ui`](https://github.com/tusen-ai/naive-ui) ★17190 — *TypeScript* — _tusen-ai_
  
  > A Vue 3 Component Library. Fairly Complete. Theme Customizable. Uses TypeScript. Fast.
- [`Nuitka/Nuitka`](https://github.com/Nuitka/Nuitka) ★13271 — *Python* — _Nuitka_
  
  > Nuitka is a Python compiler written in Python.  It's fully compatible with Python 2.6, 2.7, 3.4-3.13. You feed it your Python app, it does a lot of clever things, and spits out an executable or extension module.
- [`zhiyiYo/PyQt-Fluent-Widgets`](https://github.com/zhiyiYo/PyQt-Fluent-Widgets) ★6750 — *Python* — _zhiyiYo_
  
  > A fluent design widgets library based on C++ Qt/PyQt/PySide. Make Qt Great Again.
- [`duckdb/duckdb`](https://github.com/duckdb/duckdb) ★30102 — *C++* — _duckdb_
...
- [`Hex-Dragon/PCL2`](https://github.com/Hex-Dragon/PCL2) ★4120 — *Visual Basic .NET* — _Hex-Dragon_
...
- [`TGwear/TGwear`](https://github.com/TGwear/TGwear) ★42 — *Java* — _TGwear_
  
  > ‎Telegram for Android watch & wearos
- [`groupultra/telegram-search`](https://github.com/groupultra/telegram-search) ★2231 — *TypeScript* — _groupultra_
...
- [`chenzyadb/CuprumTurbo-Scheduler`](https://github.com/chenzyadb/CuprumTurbo-Scheduler) ★370 — *Shell* — _chenzyadb_
...
- [`KernelSU-Next/KernelSU-Next`](https://github.com/KernelSU-Next/KernelSU-Next) ★1662 — *Kotlin* — _KernelSU-Next_
...
- [`themepark-dev/theme.park`](https://github.com/themepark-dev/theme.park) ★2727 — *CSS* — _themepark-dev_
  
  > A collection of themes/skins for 50 selfhosted apps!

## 📂 VSCode (3 Repos)

- [`voideditor/void`](https://github.com/voideditor/void) ★23270 — *TypeScript* — _voideditor_
- [`yeongpin/cursor-free-vip`](https://github.com/yeongpin/cursor-free-vip) ★29284 — *Python* — _yeongpin_
  
  > [Support 0.49.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
- [`artisticat1/obsidian-latex-suite`](https://github.com/artisticat1/obsidian-latex-suite) ★1826 — *TypeScript* — _artisticat1_
...
- [`goto456/stopwords`](https://github.com/goto456/stopwords) ★5150 — *None* — _goto456_
...
- [`krillinai/KlicStudio`](https://github.com/krillinai/KlicStudio) ★7705 — *Go* — _krillinai_
  
  > A video translation and dubbing tool powered by LLMs, offering professional-grade translations and one-click full-process deployment. It can generate content optimized for platforms like YouTube，TikTok, and Shorts.  基于AI大模型的视频翻译和配音工具，专业级翻译，一键部署全流程，可以生成适配抖音，小红书，哔哩哔哩，视频号，TikTok，Youtube Shorts等形态的内容
- [`comfyanonymous/ComfyUI`](https://github.com/comfyanonymous/ComfyUI) ★79196 — *Python* — _comfyanonymous_
  
  > The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
- [`agentcodee/cursor-free-everyday`](https://github.com/agentcodee/cursor-free-everyday) ★4137 — *Rust* — _agentcodee_
  
  > 完全免费, 自动获取新账号,一键重置新额度,  解决机器码问题, 自动满额度
- [`browser-use/workflow-use`](https://github.com/browser-use/workflow-use) ★3193 — *TypeScript* — _browser-use_
  
  > ⚙️ Create and run workflows (RPA 2.0)
- [`punkpeye/awesome-mcp-servers`](https://github.com/punkpeye/awesome-mcp-servers) ★53805 — *None* — _punkpeye_
  
  > A collection of MCP servers.
- [`xming521/WeClone`](https://github.com/xming521/WeClone) ★13278 — *Python* — _xming521_
...
- [`simular-ai/Agent-S`](https://github.com/simular-ai/Agent-S) ★5382 — *Python* — _simular-ai_
  
  > Agent S: an open agentic framework that uses computers like a human
- [`x1xhlol/system-prompts-and-models-of-ai-tools`](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) ★56028 — *None* — _x1xhlol_
  
  > FULL v0, Cursor, Manus, Same.dev, Lovable, Devin, Replit Agent, Windsurf Agent, VSCode Agent, Dia Browser & Trae AI (And other Open Sourced) System Prompts, Tools & AI Models.
- [`hacksider/Deep-Live-Cam`](https://github.com/hacksider/Deep-Live-Cam) ★70708 — *Python* — _hacksider_
  
  > real time face swap and one-click video deepfake with only a single image
- [`yeongpin/cursor-free-vip`](https://github.com/yeongpin/cursor-free-vip) ★29284 — *Python* — _yeongpin_
  
  > [Support 0.49.x]（Reset Cursor AI MachineID & Bypass Higher Token Limit） Cursor Ai ，自动重置机器ID ， 免费升级使用Pro功能: You've reached your trial request limit. / Too many free trial accounts used on this machine. Please upgrade to pro. We have this limit in place to prevent abuse. Please let us know if you believe this is a mistake.
- [`chatanywhere/GPT_API_free`](https://github.com/chatanywhere/GPT_API_free) ★30201 — *Python* — _chatanywhere_
...
- [`github/github-mcp-server`](https://github.com/github/github-mcp-server) ★15176 — *Go* — _github_
...
- [`HunterPie/HunterPie`](https://github.com/HunterPie/HunterPie) ★1002 — *C#* — _HunterPie_
...
- [`libnoname/noname`](https://github.com/libnoname/noname) ★3535 — *JavaScript* — _libnoname_
...
- [`fscarmen/ArgoX`](https://github.com/fscarmen/ArgoX) ★1420 — *Shell* — _fscarmen_
  
  > Argo Xray for VPS one-click script. 一键脚本
- [`frankiejun/serv00-play`](https://github.com/frankiejun/serv00-play) ★2134 — *Shell* — _frankiejun_
  
  > serv00/hostuno 上的一些应用，包括argo+vmess/vmess+ws/hy2/socks5/mtproto/alist/哪吒探针|面板 等, 自动化部署、批量保号、进程防杀、消息推送
- [`eooce/Sing-box`](https://github.com/eooce/Sing-box) ★2961 — *Shell* — _eooce_
  
  > 既然来了，就留下你的Star吧！Serv00 | CT8 | VPS | 游戏机 | sing-box(reality + hy2 + vmess-argo +tuic5)四合一无交互一键安装脚本(已适配Alpine)，支持纯V6 vps，默认解锁GPT和奈飞
- [`yonggekkk/sing-box-yg`](https://github.com/yonggekkk/sing-box-yg) ★4420 — *Shell* — _yonggekkk_
  
  > Sing-box精装桶四合一协议VPS专用脚本：三大独家功能！自签/acme双证书切换、Argo固定临时双隧道（可共存）、Psiphon赛风VPN（30个国家）分流功能。Hostuno三合一代理脚本
- [`ermaozi/get_subscribe`](https://github.com/ermaozi/get_subscribe) ★7723 — *Python* — _ermaozi_
  
  > ✈️ 白嫖免费机场  / 免费VPN -> 自动获取免 clash/v2ray/trojan/sr/ssr 订阅链接，持续更新 | 科学上网 | 翻墙

## 📂 interesting (17 Repos)

- [`bee-san/Ciphey`](https://github.com/bee-san/Ciphey) ★19528 — *Python* — _bee-san_
  
  > ⚡ Automatically decrypt encryptions without knowing the key or cipher, decode encodings, and crack hashes ⚡
- [`hmjz100/123panYouthMember`](https://github.com/hmjz100/123panYouthMember) ★403 — *JavaScript* — _hmjz100_
  
  > 123 云盘会员青春版 - 在 123 云盘超过 1GB 上限下载文件，显示身份信息为会员；123 云盘下载辅助增强脚本 - 123云盘 - 用户脚本 - 解锁123云盘下载
- [`HuLaSpark/HuLa`](https://github.com/HuLaSpark/HuLa) ★2977 — *Vue* — _HuLaSpark_
  
  > 🍀 HuLa是一款基于Tauri v2+Vue3的跨平台即时通讯桌面应用（不仅仅是即时通讯），兼容Windows、MacOS、Linux、Android、IOS
- [`TapXWorld/ChinaTextbook`](https://github.com/TapXWorld/ChinaTextbook) ★37137 — *Roff* — _TapXWorld_
  
  > 所有小初高、大学PDF教材。
- [`duplicati/duplicati`](https://github.com/duplicati/duplicati) ★12665 — *C#* — _duplicati_
  
  > Store securely encrypted backups in the cloud!
- [`cuixueshe/earthworm`](https://github.com/cuixueshe/earthworm) ★8592 — *TypeScript* — _cuixueshe_
...
- [`ayangweb/BongoCat`](https://github.com/ayangweb/BongoCat) ★6419 — *TypeScript* — _ayangweb_
  ...
  > 🐱 跨平台桌宠 BongoCat，为桌面增添乐趣！
- [`Anduin2017/HowToCook`](https://github.com/Anduin2017/HowToCook) ★88450 — *Dockerfile* — _Anduin2017_
  
  > 程序员在家做饭方法指南。Programmer's guide about how to cook at home (Simplified Chinese only).
- [`Cute-Dress/Dress`](https://github.com/Cute-Dress/Dress) ★1494 — *Ruby* — _Cute-Dress_
...
- [`keleus/BewlyCat`](https://github.com/keleus/BewlyCat) ★269 — *Vue* — _keleus_
  ...
  > BewlyCat——基于BewlyBewly开发
- [`MlgmXyysd/Xiaomi-BootLoader-Questionnaire`](https://github.com/MlgmXyysd/Xiaomi-BootLoader-Questionnaire) ★4085 — *None* — _MlgmXyysd_
...
- [`tailscale/tailscale`](https://github.com/tailscale/tailscale) ★22992 — *Go* — _tailscale_
  
  > The easiest, most secure way to use WireGuard and 2FA.

## 📂 Linux (16 Repos)

- [`kholia/OSX-KVM`](https://github.com/kholia/OSX-KVM) ★21775 — *Python* — _kholia_
...
- [`SuperManito/LinuxMirrors`](https://github.com/SuperManito/LinuxMirrors) ★4615 — *Shell* — _SuperManito_
...
- [`LazyVim/starter`](https://github.com/LazyVim/starter) ★1338 — *Lua* — _LazyVim_
  
  > Starter template for LazyVim
- [`LazyVim/LazyVim`](https://github.com/LazyVim/LazyVim) ★21133 — *Lua* — _LazyVim_
  
  > Neovim config for the lazy
- [`PintaProject/Pinta`](https://github.com/PintaProject/Pinta) ★2593 — *C#* — _PintaProject_
...
- [`ruffle-rs/ruffle`](https://github.com/ruffle-rs/ruffle) ★16746 — *Rust* — _ruffle-rs_
  ...
  > A Flash Player emulator written in Rust
- [`vim/vim`](https://github.com/vim/vim) ★38322 — *Vim Script* — _vim_
...
- [`nektos/act`](https://github.com/nektos/act) ★63503 — *Go* — _nektos_
  
  > Run your GitHub Actions locally 🚀
- [`actions/setup-python`](https://github.com/actions/setup-python) ★1902 — *TypeScript* — _actions_
  
  > Set up your GitHub Actions workflow with a specific version of Python
- [`simonecorsi/mawesome`](https://github.com/simonecorsi/mawesome) ★108 — *JavaScript* — _simonecorsi_
...
- [`TG-Twilight/Starstruck`](https://github.com/TG-Twilight/Starstruck) ★45 — *Python* — _TG-Twilight_
...
- [`yoshi389111/github-profile-3d-contrib`](https://github.com/yoshi389111/github-profile-3d-contrib) ★1293 — *TypeScript* — _yoshi389111_
...
- [`TG-Twilight/Starstruck`](https://github.com/TG-Twilight/Starstruck) ★45 — *Python* — _TG-Twilight_
  ...
  > Starstruck是一个能让你快速统计某个 GitHub 仓库被哪些“显赫人物” Star 过的工具，顺便也能看看大佬们各自的“影响力”。| Starstruck is a tool that quickly shows you which “influential developers” have starred a GitHub repo — and lets you check out their own impact, too.
- [`LordDashMe/github-contribution-stats`](https://github.com/LordDashMe/github-contribution-stats) ★626 — *JavaScript* — _LordDashMe_
  
  > Dynamically generated Github Contribution Stats. :chart_with_upwards_trend: :calendar:
- [`anuraghazra/github-readme-stats`](https://github.com/anuraghazra/github-readme-stats) ★73680 — *JavaScript* — _anuraghazra_
...
- [`Karben233/bili-hardcore`](https://github.com/Karben233/bili-hardcore) ★1014 — *Python* — _Karben233_
  
  > bilibili 硬核会员 AI 自动答题脚本，直接调用 B 站 API，非 OCR 实现
- [`1250422131/bilibilias`](https://github.com/1250422131/bilibilias) ★1242 — *Kotlin* — _1250422131_
  
  > 哔哩哔哩解析工具，一个辅助缓存下载B站视频番剧的APP，帮助你快速便捷的缓存B站视频和番剧。

## 📂 浏览器 (8 Repos)

- [`mozilla-firefox/firefox`](https://github.com/mozilla-firefox/firefox) ★7813 — *JavaScript* — _mozilla-firefox_
  
  > The official repository of Mozilla's Firefox web browser.
- [`dudor/BookmarkHub`](https://github.com/dudor/BookmarkHub) ★1703 — *TypeScript* — _dudor_
  
  > BookmarkHub , sync bookmarks across different browsers
- [`floccusaddon/floccus`](https://github.com/floccusaddon/floccus) ★6673 — *JavaScript* — _floccusaddon_
...
- [`hoothin/UserScripts`](https://github.com/hoothin/UserScripts) ★3582 — *JavaScript* — _hoothin_
  
  > Greasemonkey scripts ( Pagetual / Picviewer CE+ / DownloadAllContent ) 油猴腳本集 ユーザースクリプト集
- [`zen-browser/desktop`](https://github.com/zen-browser/desktop) ★32642 — *C++* — _zen-browser_
...
- [`giscus/giscus`](https://github.com/giscus/giscus) ★9845 — *TypeScript* — _giscus_
...
- [`weepwood/Sync-Bangumi-to-Notion`](https://github.com/weepwood/Sync-Bangumi-to-Notion) ★1 — *Python* — _weepwood_
- [`utterance/utterances`](https://github.com/utterance/utterances) ★9348 — *TypeScript* — _utterance_
  
  > :crystal_ball: A lightweight comments widget built on GitHub issues
- [`craigary/nobelium`](https://github.com/craigary/nobelium) ★3087 — *JavaScript* — _craigary_
  
  > A static blog build on top of Notion and NextJS, deployed on Vercel.
- [`tangly1024/NotionNext`](https://github.com/tangly1024/NotionNext) ★9509 — *JavaScript* — _tangly1024_
...
- [`runjuu/InputSourcePro`](https://github.com/runjuu/InputSourcePro) ★1545 — *Swift* — _runjuu_
  
  > Switch and track your input sources with ease ✨
- [`noah-nuebling/mac-mouse-fix`](https://github.com/noah-nuebling/mac-mouse-fix) ★7163 — *Objective-C* — _noah-nuebling_
...
- [`YanG-1989/m3u`](https://github.com/YanG-1989/m3u) ★9149 — *Shell* — _YanG-1989_
  
  > 直播源
- [`Archmage83/Android_apk`](https://github.com/Archmage83/Android_apk) ★312 — *None* — _Archmage83_
